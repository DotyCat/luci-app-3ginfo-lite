...
function renderDuplexText(view, value) {
	var text = value == null ? '' : String(value);
	var m = text.match(/^DL:\s*(.*?)\s+\|?\s*UL:\s*(.*)$/);
	if (!m) {
		view.textContent = text;
		return;
	}
	dom.content(view, E('div', {
		'class': 'ginfo-duplex'
	}, [E('div', {
		'class': 'ginfo-duplex-row'
	}, [E('span', {
		'class': 'ginfo-duplex-label'
	}, ['DL:']), E('span', {
		'class': 'ginfo-duplex-value'
	}, [m[1]])]), E('div', {
		'class': 'ginfo-duplex-row'
	}, [E('span', {
		'class': 'ginfo-duplex-label'
...
function renderRxText(view, value) {
	var text = value == null ? '' : String(value);
	...
	var rows = [];
	parts.slice(0, 4).forEach(function(v, i) {
		if ((i % 2) === 0)
			rows.push([]);
		...
		row.forEach(function(item, idx) {
			if (idx > 0)
				children.push(E('span', {
					'class': 'ginfo-rx-separator'
				}, ['|']));
			children.push(E('span', {
				'class': 'ginfo-rx-item'
			}, [E('span', {
				'class': 'ginfo-rx-label'
			}, ['RX%d: '.format(item.index)]), E('span', {
				'class': 'ginfo-rx-value'
			}, [item.value])]));
		});
		return E('div', {
			'class': 'ginfo-rx-row'
...
return view.extend({
	...
	render: function(data) {
							...
							return L.resolveDefault(fs.exec_direct('/usr/share/3ginfo-lite/3ginfo.sh', 'json')).then(function(res) {
								...
								if (!json.cport.includes('192.')) {
									if (json.signal == '0' || json.signal == '') {
										fs.exec('sleep 3');
										if (json.signal == '0' || json.signal == '' || json.signal == '-') {
											L.ui.showModal(_('device-info'), [E('p', {
												'class': 'spinning'
								...
								if (document.getElementById('roaming')) {
									var view = document.getElementById("roaming");
									if (json.roaming == '1') {
										view.textContent = _('Roaming');
									} else if (json.roaming == '0') {
										view.textContent = _('Home network');
									} else {
										view.textContent = '-';
									}
								}
								...
								if (document.getElementById('ambr')) {
									var view = document.getElementById("ambr");
									var viewn = document.getElementById("ambr").parentElement;
									if (json.ambr == '' || json.ambr == '-') {
										view.textContent = '-';
									} else {
										renderDuplexText(view, json.ambr);
										viewn.style.display = "";
									}
								}
								...
								if (document.getElementById('mac_rate')) {
									var view = document.getElementById('mac_rate');
									var viewn = document.getElementById('mac_rate').parentElement;
									if (json.mac_rate == '' || json.mac_rate == '-') {
										view.textContent = '-';
										viewn.style.display = 'none';
									} else {
										renderDuplexText(view, json.mac_rate);
										viewn.style.display = '';
									}
								}
								if (document.getElementById('prssi')) {
									var view = document.getElementById('prssi');
									var viewn = document.getElementById('prssi').parentElement;
									if (json.prssi == '' || json.prssi == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.prssi);
									}
								}
								if (document.getElementById('prsrp')) {
									var view = document.getElementById('prsrp');
									var viewn = document.getElementById('prsrp').parentElement;
									if (json.prsrp == '' || json.prsrp == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.prsrp);
									}
								}
								if (document.getElementById('psinr')) {
									var view = document.getElementById('psinr');
									var viewn = document.getElementById('psinr').parentElement;
									if (json.psinr == '' || json.psinr == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.psinr);
									}
								}
								if (document.getElementById('pbw')) {
									var view = document.getElementById('pbw');
									var viewn = document.getElementById('pbw').parentElement;
									if (json.pbw == '' || json.pbw == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.pbw);
									}
								}
								if (document.getElementById('pspeed')) {
									var view = document.getElementById('pspeed');
									var viewn = document.getElementById('pspeed').parentElement;
									if (json.pspeed == '' || json.pspeed == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.pspeed);
									}
								}
								if (document.getElementById('pmcs')) {
									var view = document.getElementById('pmcs');
									var viewn = document.getElementById('pmcs').parentElement;
									if (json.pmcs == '' || json.pmcs == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.pmcs);
									}
								}
								if (document.getElementById('ptwr')) {
									var view = document.getElementById('ptwr');
									var viewn = document.getElementById('ptwr').parentElement;
									if (json.ptwr == '' || json.ptwr == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										view.textContent = json.ptwr;
									}
								}
								if (document.getElementById('s1rssi')) {
									var view = document.getElementById('s1rssi');
									var viewn = document.getElementById('s1rssi').parentElement;
									if (json.s1rssi == '' || json.s1rssi == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s1rssi);
									}
								}
								if (document.getElementById('s1rsrp')) {
									var view = document.getElementById('s1rsrp');
									var viewn = document.getElementById('s1rsrp').parentElement;
									if (json.s1rsrp == '' || json.s1rsrp == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s1rsrp);
									}
								}
								if (document.getElementById('s1sinr')) {
									var view = document.getElementById('s1sinr');
									var viewn = document.getElementById('s1sinr').parentElement;
									if (json.s1sinr == '' || json.s1sinr == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s1sinr);
									}
								}
								if (document.getElementById('s1bw')) {
									var view = document.getElementById('s1bw');
									var viewn = document.getElementById('s1bw').parentElement;
									if (json.s1bw == '' || json.s1bw == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s1bw);
									}
								}
								if (document.getElementById('s1speed')) {
									var view = document.getElementById('s1speed');
									var viewn = document.getElementById('s1speed').parentElement;
									if (json.s1speed == '' || json.s1speed == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s1speed);
									}
								}
								if (document.getElementById('s1mcs')) {
									var view = document.getElementById('s1mcs');
									var viewn = document.getElementById('s1mcs').parentElement;
									if (json.s1mcs == '' || json.s1mcs == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s1mcs);
									}
								}
								if (document.getElementById('s1twr')) {
									var view = document.getElementById('s1twr');
									var viewn = document.getElementById('s1twr').parentElement;
									if (json.s1twr == '' || json.s1twr == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										view.textContent = json.s1twr;
									}
								}
								if (document.getElementById('s2rssi')) {
									var view = document.getElementById('s2rssi');
									var viewn = document.getElementById('s2rssi').parentElement;
									if (json.s2rssi == '' || json.s2rssi == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s2rssi);
									}
								}
								if (document.getElementById('s2rsrp')) {
									var view = document.getElementById('s2rsrp');
									var viewn = document.getElementById('s2rsrp').parentElement;
									if (json.s2rsrp == '' || json.s2rsrp == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s2rsrp);
									}
								}
								if (document.getElementById('s2sinr')) {
									var view = document.getElementById('s2sinr');
									var viewn = document.getElementById('s2sinr').parentElement;
									if (json.s2sinr == '' || json.s2sinr == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s2sinr);
									}
								}
								if (document.getElementById('s2bw')) {
									var view = document.getElementById('s2bw');
									var viewn = document.getElementById('s2bw').parentElement;
									if (json.s2bw == '' || json.s2bw == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s2bw);
									}
								}
								if (document.getElementById('s2speed')) {
									var view = document.getElementById('s2speed');
									var viewn = document.getElementById('s2speed').parentElement;
									if (json.s2speed == '' || json.s2speed == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s2speed);
									}
								}
								if (document.getElementById('s2mcs')) {
									var view = document.getElementById('s2mcs');
									var viewn = document.getElementById('s2mcs').parentElement;
									if (json.s2mcs == '' || json.s2mcs == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s2mcs);
									}
								}
								if (document.getElementById('s2twr')) {
									var view = document.getElementById('s2twr');
									var viewn = document.getElementById('s2twr').parentElement;
									if (json.s2twr == '' || json.s2twr == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										view.textContent = json.s2twr;
									}
								}
								if (document.getElementById('s3rssi')) {
									var view = document.getElementById('s3rssi');
									var viewn = document.getElementById('s3rssi').parentElement;
									if (json.s3rssi == '' || json.s3rssi == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s3rssi);
									}
								}
								if (document.getElementById('s3rsrp')) {
									var view = document.getElementById('s3rsrp');
									var viewn = document.getElementById('s3rsrp').parentElement;
									if (json.s3rsrp == '' || json.s3rsrp == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s3rsrp);
									}
								}
								if (document.getElementById('s3sinr')) {
									var view = document.getElementById('s3sinr');
									var viewn = document.getElementById('s3sinr').parentElement;
									if (json.s3sinr == '' || json.s3sinr == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s3sinr);
									}
								}
								if (document.getElementById('s3bw')) {
									var view = document.getElementById('s3bw');
									var viewn = document.getElementById('s3bw').parentElement;
									if (json.s3bw == '' || json.s3bw == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s3bw);
									}
								}
								if (document.getElementById('s3speed')) {
									var view = document.getElementById('s3speed');
									var viewn = document.getElementById('s3speed').parentElement;
									if (json.s3speed == '' || json.s3speed == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s3speed);
									}
								}
								if (document.getElementById('s3mcs')) {
									var view = document.getElementById('s3mcs');
									var viewn = document.getElementById('s3mcs').parentElement;
									if (json.s3mcs == '' || json.s3mcs == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s3mcs);
									}
								}
								if (document.getElementById('s3twr')) {
									var view = document.getElementById('s3twr');
									var viewn = document.getElementById('s3twr').parentElement;
									if (json.s3twr == '' || json.s3twr == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										view.textContent = json.s3twr;
									}
								}
								if (document.getElementById('s4rssi')) {
									var view = document.getElementById('s4rssi');
									var viewn = document.getElementById('s4rssi').parentElement;
									if (json.s4rssi == '' || json.s4rssi == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s4rssi);
									}
								}
								if (document.getElementById('s4rsrp')) {
									var view = document.getElementById('s4rsrp');
									var viewn = document.getElementById('s4rsrp').parentElement;
									if (json.s4rsrp == '' || json.s4rsrp == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s4rsrp);
									}
								}
								if (document.getElementById('s4sinr')) {
									var view = document.getElementById('s4sinr');
									var viewn = document.getElementById('s4sinr').parentElement;
									if (json.s4sinr == '' || json.s4sinr == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderRxText(view, json.s4sinr);
									}
								}
								if (document.getElementById('s4bw')) {
									var view = document.getElementById('s4bw');
									var viewn = document.getElementById('s4bw').parentElement;
									if (json.s4bw == '' || json.s4bw == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s4bw);
									}
								}
								if (document.getElementById('s4speed')) {
									var view = document.getElementById('s4speed');
									var viewn = document.getElementById('s4speed').parentElement;
									if (json.s4speed == '' || json.s4speed == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s4speed);
									}
								}
								if (document.getElementById('s4mcs')) {
									var view = document.getElementById('s4mcs');
									var viewn = document.getElementById('s4mcs').parentElement;
									if (json.s4mcs == '' || json.s4mcs == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										renderDuplexText(view, json.s4mcs);
									}
								}
								if (document.getElementById('s4twr')) {
									var view = document.getElementById('s4twr');
									var viewn = document.getElementById('s4twr').parentElement;
									if (json.s4twr == '' || json.s4twr == '-') {
										view.textContent = '-';
									} else {
										viewn.style.display = "";
										view.textContent = json.s4twr;
									}
								}
								...
								if (document.getElementById('s1band')) {
									...
									var viewn = document.getElementById("s1band").parentElement;
								...
								if (document.getElementById('s2band')) {
									...
									var viewn = document.getElementById("s2band").parentElement;
								...
								if (document.getElementById('s3band')) {
									...
									var viewn = document.getElementById("s3band").parentElement;
								...
								if (document.getElementById('s4band')) {
									...
									var viewn = document.getElementById("s4band").parentElement;
		...
		m = new form.JSONMap(this.formdata, _('device-info'));
		s = m.section(form.TypedSection, '3ginfo', '', null);
		s.anonymous = true;
		s.render = L.bind(function(view, section_id) {
			return E('div', {
				'class': 'cbi-section ginfo-dashboard'
			}, [E('style', {}, [dashboardStyle]), E('div', {
				'class': 'ginfo-topbar'
			}, [E('div', {
				'class': 'ginfo-title'
			}, [E('strong', {}, [_('')]), E('span', {}, [_('Modem status and cellular information')]), ]), E('div', {
				'class': 'ginfo-actions'
			}, [E('button', {
				'id': 'modc',
				'disabled': 'true',
				'data-tooltip': _('Modem selection menu'),
				'class': 'btn cbi-button ginfo-icon-button',
				...
				'title': null,
				'id': 'simv',
				'style': 'visibility: hidden; padding: 4px;',
				'click': ui.createHandlerFn(this, function() {
				...
				'style': 'width:24px; height:auto; padding: 1%;',
				'title': _(''),
				'class': 'middle',
			}), E('span', {
				'class': 'cbi-tooltip',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('Primary (PCC) BAND | PCI & EARFCN')]), E('td', {
				'class': 'td left',
				'id': 'pband'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('Primary (PCC) BandWidth & RB Number')]), E('td', {
				'class': 'td left',
				'id': 'pbw'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('Primary (PCC) MIMO & MCS & Modulation')]), E('td', {
				'class': 'td left',
				'id': 'pmcs'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('Primary (PCC) PUCCH & PUSCH TX Power')]), E('td', {
				'class': 'td left',
				'id': 'ptwr'
			}, ['-']), ]), E('tr', {
				'class': 'tr'
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SCC1) BAND | PCI & EARFCN')]), E('td', {
				'class': 'td left',
				'id': 's1band'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC1) BandWidth & RB Number')]), E('td', {
				'class': 'td left',
				'id': 's1bw'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC1) MIMO & MCS & Modulation')]), E('td', {
				'class': 'td left',
				'id': 's1mcs'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC1) PUCCH & PUSCH TX Power')]), E('td', {
				'class': 'td left',
				'id': 's1twr'
			}, ['-']), ]), E('tr', {
				'class': 'tr'
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SCC2) BAND | PCI & EARFCN')]), E('td', {
				'class': 'td left',
				'id': 's2band'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC2) BandWidth & RB Number')]), E('td', {
				'class': 'td left',
				'id': 's2bw'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC2) MIMO & MCS & Modulation')]), E('td', {
				'class': 'td left',
				'id': 's2mcs'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC2) PUCCH & PUSCH TX Power')]), E('td', {
				'class': 'td left',
				'id': 's2twr'
			}, ['-']), ]), E('tr', {
				'class': 'tr'
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SCC3) BAND | PCI & EARFCN')]), E('td', {
				'class': 'td left',
				'id': 's3band'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC3) BandWidth & RB Number')]), E('td', {
				'class': 'td left',
				'id': 's3bw'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC3) MIMO & MCS & Modulation ')]), E('td', {
				'class': 'td left',
				'id': 's3mcs'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC3) PUCCH & PUSCH TX Power')]), E('td', {
				'class': 'td left',
				'id': 's3twr'
			}, ['-']), ]), E('tr', {
				'class': 'tr'
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SCC4) BAND | PCI & EARFCN')]), E('td', {
				'class': 'td left',
				'id': 's4band'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC4) BandWidth & RB Number')]), E('td', {
				'class': 'td left',
				'id': 's4bw'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC4) MIMO & MCS & Modulation ')]), E('td', {
				'class': 'td left',
				'id': 's4mcs'
			}, ['-']), ]), E('tr', {
				'class': 'tr',
				...
				'class': 'td left',
				'width': '33%'
			}, [_('CA (SSC4) PUCCH & PUSCH TX Power')]), E('td', {
				'class': 'td left',
				'id': 's4twr'
			}, ['-']), ]), ])]);
		}, o, this);
